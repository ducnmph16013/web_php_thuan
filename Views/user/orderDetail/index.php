<div class="container">
    ...
    <?php if (isset($order) && $order) : ?>
        <div class="row mb-2">
            <div class="col-md-6">
                <p class="my-2">Người nhận: <?= isset($order['name']) ? $order['name'] : "" ?></p>
                <p class="my-2">Số điện thoại: <?= isset($order['phone_number']) ? $order['phone_number'] : "" ?></p>
                <p class="my-2">Địa chỉ giao hàng: <?= isset($order['address']) ? $order['address'] : "" ?></p>
    ...
    <div class="table mb-5">
        <table class="table table-striped table-hover">
            <thead class="table-primary">
                <tr>
                    <th class="ps-5 py-4 fs-3 fw-bold">Tên sản phẩm</th>
                    <th class=" py-4 fs-3 fw-bold">Hình ảnh</th>
                    <th class=" py-4 fs-3 fw-bold">Size, Màu</th>
                    <th class="py-4 fs-3 fw-bold">Số lượng</th>
                    <th class="py-4 fs-3 fw-bold">Giá gốc</th>
                    <th class="py-4 fs-3 fw-bold">Giá giảm</th>
                    <th class="py-4 fs-3 fw-bold">Tổng</th>
                </tr>
            </thead>
            <tbody>
    ...
    <div class="mb-3">
        <a href="index.php?act=order" name="add-new" class="btn btn-primary">Quay lại</a>
    </div>
</div>